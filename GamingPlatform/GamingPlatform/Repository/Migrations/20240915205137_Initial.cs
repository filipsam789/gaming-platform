        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamingPlatformUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Developers_AspNetUsers_GamingPlatformUserId",
                        column: x => x.GamingPlatformUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AspNetUsers_GamingPlatformUserId",
                        column: x => x.GamingPlatformUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Developers_GamingPlatformUserId",
                table: "Developers",
                column: "GamingPlatformUserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_GamingPlatformUserId",
                table: "Users",
                column: "GamingPlatformUserId",
                unique: true);
        }

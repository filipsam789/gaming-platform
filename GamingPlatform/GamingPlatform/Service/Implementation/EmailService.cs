...
namespace Service.Implementation
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendEmailAsync(EmailMessage allMails)
        {
            ...
            {
                Sender = new MailboxAddress("Gaming Platform", _mailSettings.SmtpUserName),
                Subject = allMails.Subject
            };

            emailMessage.From.Add(new MailboxAddress("Gaming Platform", _mailSettings.SmtpUserName));
